...
| 키 | 평가표 | 항목 수 | 배점 구성 |
|----|--------|--------:|-----------|
| `fundFit` | 펀드 · 국내 · 적합 | 23 | 적합성원칙 30 + 상품설명의무 70 |
| `fundUnfit` | 펀드 · 국내 · 부적합 | 25 | 적합성원칙 30 + 상품설명의무 70 |
| `fundOverseasUnfit` | 펀드 · 해외 · 부적합 | 26 | 적합성원칙 30 + 상품설명의무 70 (투자위험 일반 8 + 해외 4) |
| `elsFit` | ELS · DLS · 적합 | 21 | 적합성원칙 40 + 상품설명의무 60 |
| `elsUnfit` | ELS · DLS · 부적합 | 20 | 적합성원칙 40 + 상품설명의무 60 |
| `bondKrw` | 원화채권 | 21 | 적합성원칙 25 + 상품설명의무 75 |
| `bondFx` | 외화채권 | 21 | 적합성원칙 25 + 상품설명의무 75 |
| `irp` | 개인형 IRP | 24 | 적합성원칙 15 + IRP설명의무 60 + 펀드설명의무 25 |

모든 표가 **기본 100점 + 가점 최대 3점 = 총 103점** 으로, 원 평가표의 배점·등급 구간·
섹션 합계를 그대로 코드화했습니다. Check Point를 모두 이행하면 103점이 산출됩니다.
...
js/sales-script-app.js         # 앱 로직 (템플릿 엔진 · 채점 · 읽기 모드 · 타이머)
