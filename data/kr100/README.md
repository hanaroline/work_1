...
## 항목별 확보율 (2026-09-09 첫 수집, 100종목 기준)
...
애널리스트 커버리지가 얇은 종목(기관 한두 곳)은 목표주가가 비거나 표본이 작습니다.
비는 항목은 화면에서 **미조회**로 두고 없는 값을 지어내지 않습니다. 국내 증권사
컨센서스는 네이버 금융·에프앤가이드가 더 촘촘하고, 공시는 DART 가 원문입니다.
