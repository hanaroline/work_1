...
(function (g) {
  ...
  var FIELDS = {
    ...
    fund: [
      ...
      { id: 'varBasis', label: '위험등급 산정 근거 (설정 3년 경과 여부)', group: '위험등급 근거', hint: '설정 3년 미만이면 실측 VaR 가 없고 자산 위험수준으로 등급을 매긴다' },
      /* 위 두 항목을 한 문장으로 묶은 것 — 3년 미만 펀드에 "VaR값 ○○%" 를 읽히면
         없는 수치를 말하게 되므로 문장째로 갈라 낸다 */
      { id: 'varMeaning', label: 'VaR 설명 문장', group: '위험등급 근거', hint: 'VaR 값·산정 근거에서 자동으로 만든다' },
