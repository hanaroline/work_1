...
- 탐색 시각: 2026-08-28T16:34:21.850Z
...
| ❌ | `naver.rendered` | 네이버 ETF 화면이 부르는 분배금 API 관찰 | 분배금 관련 호출 없음 (전체 API 호출 5건) |
...
| ✅ | `yahoo.adequacy.069500` | 배당 자료 충분한가 — KODEX 200 | TTM 배당 4건 합 849원 → 역산 0.8% (표기 0.78%) · 계산방식 dividends · 1년 시장가 152.95 vs 총수익률 155.48 (격차 2.53) |
| ✅ | `yahoo.adequacy.458730` | 배당 자료 충분한가 — TIGER 미국배당다우존스 | TTM 배당 12건 합 438원 → 역산 2.9% (표기 3.2%) · 계산방식 dividends · 1년 시장가 24.4 vs 총수익률 28.43 (격차 4.03) |
| ✅ | `yahoo.adequacy.472150` | 배당 자료 충분한가 — TIGER 배당커버드콜액티브 | TTM 배당 12건 합 4202원 → 역산 20.9% (표기 21.4%) · 계산방식 dividends · 1년 시장가 81.38 vs 총수익률 131.52 (격차 50.14) |
| ✅ | `yahoo.adequacy.498400` | 배당 자료 충분한가 — KODEX 200타겟위클리커버드콜 | TTM 배당 12건 합 2987원 → 역산 14.7% (표기 14.5%) · 계산방식 dividends · 1년 시장가 86.97 vs 총수익률 121.62 (격차 34.65) |
