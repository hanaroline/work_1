...
L.append('- 기준 2026-09-08 · 저장소 `hanaroline/work_1`')
L.append('- 세션 44개 · 주제 %d개 · 색인 항목 %d개 · 이번에 새로 올린 아티팩트 %d개\n'
...
L.append('- 페이지가 파일을 건네주는 단추(HTML·CSV·PDF 저장)는 아티팩트에서 동작하지 '
         '않습니다. `완전판매 스크립트`·`ETF 편입종목 조회` 가 여기에 해당합니다. '
         '발표자료 페이지는 `downloads` 를 선언해 두어 원본을 받을 수 있습니다.')
