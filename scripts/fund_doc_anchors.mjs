 ...
 *
 * ★ 제1부를 로마숫자로 적는 문서가 있다 ★ 한국밸류10년투자퇴직연금의 목차 쪽이다.
 *
 *   p.3 「3 제I부. 모집 또는 매출에 관한 사항 1. 집합투자기구의 명칭 … 6. 상장 및
 *        매매에 관한 사항  제2부. 집합투자기구에 관한 사항 1. 집합투자기구의 명칭 …
 *        제3부. 집합투자기구의 재무 및 운용실적 …  제4부. 집합투자기구 관련회사 …」
 *   p.8 「8 제1부. 모집 또는 매출에 관한 사항 1. 집합투자기구의 명칭: 한국밸류 …」
 *
 * **로마숫자는 목차 쪽에만 쓰고 본문 속표지는 아라비아로 적는다** — 한 문서 안에서
 * 표기가 갈린다. 그 바람에 이 목차 쪽이 목차로 안 잡혔고, 제2부가 목차 쪽(p.3)으로
 * 잡혀 진짜 제1부(p.8)보다 앞서면서 그 종목이 통째로 버려졌다.
 *
 * 그래서 이 표에서만 로마숫자를 함께 받는다. Ⅰ(U+2160)은 같은 글자의 다른 부호라
 * 같이 둔다 — 문서에서 본 것은 ASCII I 다.
 *
 * ★ 제1부·제2부 판정은 건드리지 않는다 ★ 목차만 제대로 잡히면 나머지는 저절로
 * 풀린다 — 제2부 탐색이 그 쪽을 건너뛰고 진짜 속표지를 찾고, 제1부는 이미 맞다.
 * 바로 앞에서 제2부 판정을 한 줄 조였다가 대신 계열 36종목을 죽였다. 안 건드려도
 * 되는 것은 안 건드린다.
 *
 * 흔한가 — 표본 80종목에서 로마숫자를 쓴 문서는 0건이었다(지정 11종목 중 1건).
 * 드물기 때문에 이 한 표만 넓히는 좁은 고침으로 충분하다.
 */
const TOC_MARK = /제\s*[1IⅠ]\s*부|\.{4,}|·{4,}|…{2,}/;
